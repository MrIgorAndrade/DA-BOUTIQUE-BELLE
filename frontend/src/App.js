        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              {/* Seção de Dúvidas com WhatsApp */}
              <div className="bg-gradient-to-r from-rose-100 to-pink-100 rounded-3xl shadow-2xl p-8 md:p-12">
                <div className="text-center md:text-left">
                  ...
                  <div className="flex justify-center md:justify-start">
                    <button
                      ...
                      className="px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white font-bold rounded-full hover:shadow-lg transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 flex items-center gap-3"
                    >
